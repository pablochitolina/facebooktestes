! function(e) {
    ...
    ! function() {
        ...
        e.factory("ModalService", ["$animate", "$document", "$compile", "$controller", "$http", "$rootScope", "$q", "$templateRequest", "$timeout", function(e, n, t, r, o, l, c, u, a) {
            function i() {
                var o = this,
                    i = function(e, n) {
                        var t = c.defer();
                ...
                o.showModal = function(o) {
                    var u = angular.element(n[0].body),
                        p = c.defer(),
                        d = o.controller;
                    return d ? (i(o.template, o.templateUrl).then(function(n) {
                        function i(n) {
                        ...
                        var h = t(n),
                            g = h(d);
                        $.$element = g;
                        var x = d[o.controllerAs],
                            j = r(o.controller, $, !1, o.controllerAs);
